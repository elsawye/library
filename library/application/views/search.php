				...
				<?php if (!empty($books)): ?>
					<?php foreach($books as $book): ?>
						<tr style="width: 67px; height: 86px;">
						    ...
						    <form action="<?php echo base_url(); ?>index.php/library/deleteBook" method="POST"><td><button type="submit" name="bookISBN" value="<?php echo $book->ISBN; ?>" class="delete-book">Delete Book</button></td></form>
						</tr>
				<?php endforeach; ?>
			<?php else: ?>
